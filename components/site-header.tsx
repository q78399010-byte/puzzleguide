    ...
    <header className="sticky top-0 z-50 border-b border-white/20 bg-white/70 text-ink shadow-[0_8px_30px_rgba(15,23,42,0.06)] backdrop-blur-xl supports-[backdrop-filter]:bg-white/70">
      <div className="container-page">
        <div className="flex min-h-20 items-center gap-5 py-4">
          ...
          <Link
            href={routes.search}
            className="ml-auto rounded-full border border-white/50 bg-white/70 px-4 py-2 text-sm font-semibold text-muted shadow-sm backdrop-blur transition duration-300 hover:-translate-y-0.5 hover:bg-white hover:text-action hover:shadow-lg lg:hidden"
          >
            Search
          </Link>
