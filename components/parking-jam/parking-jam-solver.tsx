const solverSteps = [
  { label: "Step 1", title: "Clear the exit lane" },
  { label: "Step 2", title: "Move blocking cars first" },
  { label: "Step 3", title: "Open space around long vehicles" },
  { label: "Step 4", title: "Guide cars toward the exit" }
];

const solverStats = [
  { label: "Difficulty", value: "Medium" },
  { label: "Moves", value: "24" },
  { label: "Estimated Time", value: "3 min" },
  { label: "Success Rate", value: "66%" }
];

export function ParkingJamSolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple four-step solving pattern for Parking Jam boards. This is
