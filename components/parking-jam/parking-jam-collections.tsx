...
const collections = [
  {
    ...
    text: "Start with simple exit lanes, short blockers, and open parking spaces.",
    href: routes.game("parking-jam")
  },
  {
    title: "Hard Levels",
    text: "Find tighter lots, trapped long vehicles, and stricter exit orders.",
  ...
  },
  {
    ...
    text: "Use the Parking Jam walkthrough hub as a daily solving path.",
    href: routes.walkthrough("parking-jam")
  },
  {
    title: "Expert Strategies",
    text: "Study exit-lane control, blocker priority, and long-vehicle traps.",
    href: routes.tip("parking-jam")
  },
  {
    title: "Speed Runs",
    text: "Practice shorter exit routes with fewer parking lot resets.",
    href: routes.solution("parking-jam")
  }
];

export function ParkingJamCollections() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Curated parking paths
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Six static collections for moving from Parking Jam basics to difficult
          walkthrough demand and faster exit-order solution routes.
        </p>
      </div>
