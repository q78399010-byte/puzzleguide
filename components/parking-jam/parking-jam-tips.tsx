const tips = [
  "Clear the exit lane first",
  "Move blocking cars before small moves",
  "Keep escape paths open",
  "Avoid trapping long vehicles",
  "Plan two moves ahead",
  "Use empty space carefully",
  "Restart early if the lot locks"
];

export function ParkingJamTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven exit-safe moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Hard Parking Jam boards are
          easier when exit lanes, long vehicles, and empty spaces are planned
          together.
        </p>
      </div>
