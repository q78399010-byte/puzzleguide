import { parkingJamFaq } from "@/data/games";

type ParkingJamFaqItem = {
  question: string;
  answer: string;
};

type ParkingJamFaqProps = {
  faq?: ParkingJamFaqItem[];
};

export function ParkingJamFaq({ faq = parkingJamFaq }: ParkingJamFaqProps) {
  return (
