...
const walkthroughBlocks = [
  {
    title: "Exit Lane",
    text: "Open the main exit before moving cars that only create short-term space."
  },
  {
    title: "Blocking Cars",
    text: "Move vehicles that block multiple lanes before clearing smaller cars."
  },
  {
    title: "Long Vehicles",
    text: "Keep enough room around buses and long cars so they do not trap the final route."
  }
];

export function ParkingJamSolutions() {
  return (
    <section className="mt-8 grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
      <article className="rounded-3xl border border-white/55 bg-white/75 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-xl sm:p-10">
        ...
        <p className="mt-4 text-sm leading-6 text-muted">
          Parking Jam solutions work best when every move opens the exit lane,
          frees a blocker, or keeps space available for long vehicles.
        </p>
        <Link
