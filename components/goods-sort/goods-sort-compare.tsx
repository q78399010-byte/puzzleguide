const games = ["Goods Sort", "Color Wood Jam", "Screw Jam", "Water Sort"];

const rows = [
  {
    label: "Difficulty",
    values: ["Medium", "Hard", "Hard", "Easy"]
  },
  {
    label: "Relaxation",
  ...
  {
    label: "Strategy",
    values: ["Shelf grouping", "Spatial exits", "Mechanical order", "Color storage"]
  },
  {
...
export function GoodsSortCompare() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Goods Sort vs Color Wood Jam vs Screw Jam vs Water Sort
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use this quick comparison to choose between relaxing shelf sorting,
          spatial wood boards, mechanical blockers, and color storage puzzles.
        </p>
      </div>
