import { goodsSortFaq } from "@/data/games";

type GoodsSortFaqItem = {
  question: string;
  answer: string;
};

type GoodsSortFaqProps = {
  faq?: GoodsSortFaqItem[];
};

export function GoodsSortFaq({ faq = goodsSortFaq }: GoodsSortFaqProps) {
  return (
