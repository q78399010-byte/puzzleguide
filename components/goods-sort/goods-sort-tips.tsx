const tips = [
  "Open shelf space first",
  "Group crowded items early",
  "Keep one lane available",
  "Avoid mixed shelf traps",
  "Plan item order ahead",
  "Watch hidden groups",
  "Restart early if shelves lock"
];

export function GoodsSortTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven shelf-safe moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Hard Goods Sort boards are
          easier when shelf space and item grouping are planned together.
        </p>
      </div>
