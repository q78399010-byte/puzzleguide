import type { UserInsight } from "@/components/solver-pro-advanced/solver-pro-advanced-data";

type SolverProUserInsightsProps = {
  insights: UserInsight[];
};

export function SolverProUserInsights({ insights }: SolverProUserInsightsProps) {
  return (
    <section className="rounded-3xl border border-white/60 bg-white/75 p-5 shadow-xl shadow-slate-900/5 backdrop-blur-xl sm:p-6">
      ...
      <h3 className="mt-3 text-3xl font-bold tracking-tight text-ink">
        Static trends from preview usage.
      </h3>
