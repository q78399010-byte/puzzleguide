type PopularGamesCardProps = {
  games: string[];
};

export function PopularGamesCard({ games }: PopularGamesCardProps) {
  return (
      ...
      <div className="mt-6 grid gap-3">
        {games.map((game, index) => (
          ...
          >
            ...
            <span className="text-sm font-bold text-ink">{game}</span>
          </article>
        ))}
      </div>
    </section>
