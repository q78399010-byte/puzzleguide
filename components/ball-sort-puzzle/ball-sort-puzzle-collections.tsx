...
const collections = [
  {
    ...
    text: "Start with empty tube basics and clean color stack routes.",
    href: routes.game(ballSortSlug)
  },
  {
    title: "Hard Levels",
    text: "Find stricter storage locks, rare color traps, and exact transfer order.",
  ...
  },
  {
    ...
    text: "Use the Ball Sort walkthrough hub as a daily solving path.",
    href: routes.walkthrough(ballSortSlug)
  },
  {
    title: "Expert Strategies",
    text: "Study empty tube timing, anchor colors, and late-board storage traps.",
    href: routes.tip(ballSortSlug)
  },
  {
    title: "Speed Runs",
    text: "Practice shorter transfer routes with fewer tube resets.",
    href: routes.solution(ballSortSlug)
  }
];

export function BallSortPuzzleCollections() {
  return (
    <section className="mt-8 rounded-3xl border border-white/55 bg-white/75 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-xl sm:p-10">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <p className="max-w-md text-sm leading-6 text-muted">
          Six static collections for moving from Ball Sort basics to difficult
          walkthrough demand and faster solution routes.
        </p>
      </div>
