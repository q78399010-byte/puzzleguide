const games = ["Ball Sort", "Water Sort", "Goods Sort", "Hexa Sort"];

const rows = [
  {
    label: "Difficulty",
    values: ["Easy", "Easy", "Medium", "Medium"]
  },
  {
    label: "Relaxation",
  ...
  {
    label: "Strategy",
    values: ["Tube storage", "Color pours", "Shelf grouping", "Stack merging"]
  },
  {
    label: "Learning Curve",
    values: ["Easy", "Easy", "Easy", "Moderate"]
  },
  {
...
export function BallSortPuzzleCompare() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Ball Sort vs Water Sort vs Goods Sort vs Hexa Sort
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use this quick comparison to choose between tube storage, color pours,
          shelf sorting, and stack-merging puzzle sessions.
        </p>
      </div>
