import { ballSortPuzzleFaq } from "@/data/games";

type BallSortPuzzleFaqItem = {
  question: string;
  answer: string;
};

type BallSortPuzzleFaqProps = {
  faq?: BallSortPuzzleFaqItem[];
};

export function BallSortPuzzleFaq({ faq = ballSortPuzzleFaq }: BallSortPuzzleFaqProps) {
  return (
