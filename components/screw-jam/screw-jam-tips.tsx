const tips = [
  "Check tray capacity first",
  "Remove blockers before key screws",
  "Keep empty slots available",
  "Avoid color mismatch traps",
  "Plan screw order ahead",
  "Watch chained obstacles",
  "Restart early if the tray locks"
];

export function ScrewJamTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven tray-safe moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Hard Screw Jam boards are
          easier when tray capacity and screw order are planned together.
        </p>
      </div>
