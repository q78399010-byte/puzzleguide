...
const collections = [
  {
    ...
    text: "Start with tray basics and simple screw matching routes.",
    href: routes.game("screw-jam")
  },
  {
    title: "Hard Levels",
    text: "Find stricter tray locks, chained blockers, and exact screw order.",
  ...
  },
  {
    ...
    text: "Use the Screw Jam walkthrough hub as a daily solving path.",
    href: routes.walkthrough("screw-jam")
  },
  {
    title: "Expert Strategies",
    text: "Study tray capacity, blocker timing, and color mismatch traps.",
    href: routes.tip("screw-jam")
  },
  {
    title: "Speed Runs",
    text: "Practice shorter screw routes with fewer tray resets.",
    href: routes.solution("screw-jam")
  }
];

export function ScrewJamCollections() {
  return (
    <section className="mt-8 rounded-3xl border border-white/55 bg-white/75 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-xl sm:p-10">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <p className="max-w-md text-sm leading-6 text-muted">
          Six static collections for moving from tray basics to difficult Screw
          Jam walkthrough demand and faster solution routes.
        </p>
      </div>
