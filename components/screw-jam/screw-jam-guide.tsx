...
const guideCards = [
  {
    title: "Guide",
    text: "Understand tray pressure, screw colors, and when to delay visible screws.",
    href: routes.game("screw-jam")
  },
  {
    title: "Walkthrough",
    text: "Jump into written level paths for tray capacity, blockers, and screw order.",
    href: routes.walkthrough("screw-jam")
  },
  {
    title: "Solutions",
    text: "Use concise solution notes when a tray locks before the final matches.",
    href: routes.solution("screw-jam")
  }
];

export function ScrewJamGuide() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold tracking-tight text-ink sm:text-6xl">
            Screw Jam Guides & Solutions
          </h2>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-muted sm:text-xl">
            Walkthroughs, tips, screw order strategies and puzzle solutions.
          </p>
        </div>
        <div className="rounded-3xl border border-white/60 bg-white/80 p-5 shadow-2xl shadow-blue-500/10 backdrop-blur-xl">
          ...
          <p className="mt-3 text-2xl font-bold tracking-tight text-ink">
            Check tray capacity before removing screws.
          </p>
          <p className="mt-3 text-sm leading-6 text-muted">
            Screw Jam levels usually fail when the tray fills with mismatched
            screws. Keep one slot open until the next color group can clear.
          </p>
        </div>
      </div>
