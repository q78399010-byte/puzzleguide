const solverSteps = [
  { label: "Step 1", title: "Check tray capacity" },
  { label: "Step 2", title: "Remove blockers first" },
  { label: "Step 3", title: "Match screws by order" },
  { label: "Step 4", title: "Keep one slot open" }
];

const solverStats = [
  { label: "Difficulty", value: "Hard" },
  { label: "Moves", value: "22" },
  { label: "Estimated Time", value: "3 min" },
  { label: "Success Rate", value: "64%" }
];

export function ScrewJamSolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple four-step solving pattern for Screw Jam boards. This is
