const games = ["Magic Sort", "Water Sort", "Ball Sort Puzzle", "Goods Sort"];

const rows = [
  {
    label: "Difficulty",
    values: ["Medium", "Easy", "Easy", "Easy"]
  },
  {
    label: "Relaxation",
    values: ["High", "High", "High", "High"]
  },
  {
    label: "Strategy",
    values: ["Color storage", "Bottle pours", "Tube transfers", "Shelf grouping"]
  },
  {
    label: "Learning Curve",
    values: ["Moderate", "Easy", "Easy", "Easy"]
  },
  {
...
export function MagicSortCompare() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Magic Sort vs Water Sort vs Ball Sort Puzzle vs Goods Sort
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use this quick comparison to choose between color storage, bottle
          pours, tube transfers, and shelf sorting puzzles.
        </p>
      </div>
