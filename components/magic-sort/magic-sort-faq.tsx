import { magicSortFaq } from "@/data/games";

type MagicSortFaqItem = {
  question: string;
  answer: string;
};

type MagicSortFaqProps = {
  faq?: MagicSortFaqItem[];
};

export function MagicSortFaq({ faq = magicSortFaq }: MagicSortFaqProps) {
  return (
