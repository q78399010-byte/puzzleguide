...
const collections = [
  {
    ...
    text: "Start with simple color groups, open storage, and forgiving transfers.",
    href: routes.game("magic-sort")
  },
  {
    title: "Hard Levels",
    text: "Find crowded boards, locked containers, and stricter storage order.",
  ...
  },
  {
    ...
    text: "Use the Magic Sort walkthrough hub as a daily solving path.",
    href: routes.walkthrough("magic-sort")
  },
  {
    title: "Expert Strategies",
    text: "Study anchor colors, rare-color timing, and temporary storage discipline.",
    href: routes.tip("magic-sort")
  },
  {
    title: "Speed Runs",
    text: "Practice shorter transfer routes with fewer sorting resets.",
    href: routes.solution("magic-sort")
  }
];

export function MagicSortCollections() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Curated sorting paths
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Six static collections for moving from Magic Sort basics to difficult
          walkthrough demand and faster color-storage solution routes.
        </p>
      </div>
