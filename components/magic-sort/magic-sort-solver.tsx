const solverSteps = [
  { label: "Step 1", title: "Choose an anchor color" },
  { label: "Step 2", title: "Keep one storage space open" },
  { label: "Step 3", title: "Move rare colors carefully" },
  { label: "Step 4", title: "Finish clean groups" }
];
...
export function MagicSortSolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple four-step solving pattern for Magic Sort boards. This is
