const tips = [
  "Build one anchor color",
  "Keep storage open",
  "Move rare colors carefully",
  "Avoid breaking clean groups",
  "Plan transfer order",
  "Watch locked containers",
  "Restart early if colors split"
];

export function MagicSortTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven storage-safe moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Hard Magic Sort boards are
          easier when anchor colors, temporary storage, and locked containers
