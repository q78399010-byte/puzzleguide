import { busEscapeFaq } from "@/data/games";

type BusEscapeFaqItem = {
  question: string;
  answer: string;
};

type BusEscapeFaqProps = {
  faq?: BusEscapeFaqItem[];
};

export function BusEscapeFaq({ faq = busEscapeFaq }: BusEscapeFaqProps) {
  return (
