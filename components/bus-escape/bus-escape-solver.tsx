const solverSteps = [
  { label: "Step 1", title: "Open the main exit lane" },
  { label: "Step 2", title: "Move side blockers first" },
  { label: "Step 3", title: "Preserve one escape space" },
  { label: "Step 4", title: "Release buses in order" }
];
...
export function BusEscapeSolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple four-step solving pattern for Bus Escape boards. This is
