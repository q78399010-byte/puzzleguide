...
const collections = [
  {
    ...
    text: "Start with center space basics and safe row-clearing routes.",
    href: routes.game("block-blast")
  },
  {
    title: "Hard Levels",
    text: "Find tighter boards, awkward shapes, and stricter placement routes.",
  ...
  },
  {
    ...
    text: "Use the Block Blast walkthrough hub as a daily solving path.",
    href: routes.walkthrough("block-blast")
  },
  {
    title: "Expert Strategies",
    text: "Study center space, row clears, and awkward-shape traps.",
    href: routes.tip("block-blast")
  },
  {
    title: "Speed Runs",
    text: "Practice shorter placement routes with fewer board resets.",
    href: routes.solution("block-blast")
  }
];

export function BlockBlastCollections() {
  return (
    <section className="mt-8 rounded-3xl border border-white/55 bg-white/75 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-xl sm:p-10">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <p className="max-w-md text-sm leading-6 text-muted">
          Six static collections for moving from Block Blast basics to difficult
          walkthrough demand and faster placement solution routes.
        </p>
      </div>
