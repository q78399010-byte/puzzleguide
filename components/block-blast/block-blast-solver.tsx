const solverSteps = [
  { label: "Step 1", title: "Keep center space open" },
  { label: "Step 2", title: "Clear rows before clogging" },
  { label: "Step 3", title: "Avoid blocking corners early" },
  { label: "Step 4", title: "Finish with combo space" }
];
...
export function BlockBlastSolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple four-step solving pattern for Block Blast boards. This is
