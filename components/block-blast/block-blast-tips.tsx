const tips = [
  ...
  "Clear rows before they clog",
  "Avoid blocking corners early",
  "Watch shape placement ahead",
  "Create combo space first",
  "Use awkward pieces carefully",
  "Restart early if the board locks"
];

export function BlockBlastTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven board-safe moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Hard Block Blast boards are
          easier when row clears, combo space, and large shape safety are planned
          together.
        </p>
      </div>
