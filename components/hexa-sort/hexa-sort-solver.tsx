const solverSteps = [
  { label: "Step 1", title: "Build one anchor stack" },
  { label: "Step 2", title: "Keep board space open" },
  { label: "Step 3", title: "Merge matching colors" },
  { label: "Step 4", title: "Finish isolated tiles" }
];
...
export function HexaSortSolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple four-step solving pattern for Hexa Sort boards. This is
