const tips = [
  "Build one anchor stack first",
  "Keep board space open",
  "Merge matching colors early",
  "Avoid isolated hex tiles",
  "Plan tile placement ahead",
  "Save corners for awkward stacks",
  "Restart early if merges lock"
];

export function HexaSortTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven merge-safe moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Hard Hexa Sort boards are
          easier when stack anchors, merge timing, and open space are planned
          together.
        </p>
      </div>
