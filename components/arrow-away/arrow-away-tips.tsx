const tips = [
  "Start with free arrows",
  "Clear outer layers first",
  "Avoid blocking exits",
  "Watch arrow directions",
  "Create more movement space",
  "Plan two moves ahead",
  "Restart early if the board becomes locked"
];

export function ArrowAwayTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven direction-safe moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Hard Arrow Away boards are
          easier when free arrows, exits, and movement space are planned together.
        </p>
      </div>
