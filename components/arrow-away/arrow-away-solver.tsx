const solverSteps = [
  { label: "Step 1", title: "Remove free arrows" },
  { label: "Step 2", title: "Clear the outer layer" },
  { label: "Step 3", title: "Create movement space" },
  { label: "Step 4", title: "Finish remaining arrows" }
];
...
export function ArrowAwaySolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple four-step solving pattern for Arrow Away boards. This is
