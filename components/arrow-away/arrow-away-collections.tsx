...
const collections = [
  {
    ...
    text: "Start with free arrows, open edges, and simple direction chains.",
    href: routes.game(arrowAwaySlug)
  },
  {
    title: "Hard Levels",
    text: "Find denser boards, blocked exits, and stricter arrow order puzzles.",
  ...
  },
  {
    ...
    text: "Use the Arrow Away walkthrough hub as a daily solving path.",
    href: routes.walkthrough(arrowAwaySlug)
  },
  {
    title: "Expert Strategies",
    text: "Study direction reads, exit control, and movement-space traps.",
    href: routes.tip(arrowAwaySlug)
  },
  {
    title: "Speed Runs",
    text: "Practice shorter arrow removal routes with fewer board resets.",
    href: routes.solution(arrowAwaySlug)
  }
];

export function ArrowAwayCollections() {
  return (
    <section className="mt-8 rounded-3xl border border-white/55 bg-white/75 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-xl sm:p-10">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <p className="max-w-md text-sm leading-6 text-muted">
          Six static collections for moving from Arrow Away basics to difficult
          walkthrough demand and faster direction-order solution routes.
        </p>
      </div>
