...
const guideCards = [
  {
    title: "Guide",
    text: "Understand arrow directions, movement space, and when to delay blocked arrows.",
    href: routes.game(arrowAwaySlug)
  },
  {
    title: "Walkthrough",
    text: "Jump into written level paths for free arrows, outer layers, and cleanup moves.",
    href: routes.walkthrough(arrowAwaySlug)
  },
  {
    title: "Solutions",
    text: "Use concise solution notes when a board locks near the final arrow group.",
    href: routes.solution(arrowAwaySlug)
  }
];

export function ArrowAwayGuide() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold tracking-tight text-ink sm:text-6xl">
            Arrow Away Guides & Solutions
          </h2>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-muted sm:text-xl">
            Walkthroughs, arrow directions, movement strategies and puzzle solutions.
          </p>
        </div>
        <div className="rounded-3xl border border-white/60 bg-white/80 p-5 shadow-2xl shadow-blue-500/10 backdrop-blur-xl">
          ...
          <p className="mt-3 text-2xl font-bold tracking-tight text-ink">
            Start with free arrows before touching trapped chains.
          </p>
          <p className="mt-3 text-sm leading-6 text-muted">
            Arrow Away boards usually fail when blocked arrows are moved before
            the outer layer has opened. Clear free directions first, then use the
            new space to release the remaining arrows.
          </p>
        </div>
      </div>
