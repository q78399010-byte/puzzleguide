import { arrowAwayFaq } from "@/data/games";

type ArrowAwayFaqItem = {
  question: string;
  answer: string;
};

type ArrowAwayFaqProps = {
  faq?: ArrowAwayFaqItem[];
};

export function ArrowAwayFaq({ faq = arrowAwayFaq }: ArrowAwayFaqProps) {
  return (
