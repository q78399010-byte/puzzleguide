...
export function SolverPreviewCard({
  ...
  return (
    <article
      className={[
        "flex h-full flex-col rounded-3xl border bg-white/80 p-5 shadow-xl shadow-slate-900/5 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-2xl sm:p-6",
        isActive
