...
const solverStats = [
  {
    label: "Best Move",
    value: "Slide bus E down",
    text: "Clearing the right lane opens the exit path for bus B."
  },
  {
    label: "Combo Chance",
    value: "57%",
    text: "The east lane move can unlock two short slides in sequence."
  },
  {
    label: "Danger Level",
    value: "High",
    text: "The center lane is blocked and the exit gap is narrow."
  },
  {
    label: "Next Strategy",
    value: "Free center lane",
    text: "Move W after E so bus B can reach the exit tile."
  }
];

export function BusEscapeSolverPreview() {
  return (
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-action">
            Bus Escape Solver Preview
          </p>
          <h3 className="mt-3 text-2xl font-bold tracking-tight text-ink">
            Exit lane route
          </h3>
          <p className="mt-3 text-sm leading-6 text-muted">
            Static mock data for a compact traffic board.
          </p>
        </div>
