...
const solverStats = [
  {
    label: "Best Move",
    value: "Clear shelf C",
    text: "Move the open C item into the top shelf gap first."
  },
  {
    label: "Combo Chance",
    value: "74%",
    text: "Shelf C can trigger a second match after the A pair shifts."
  },
  {
    label: "Danger Level",
    value: "Low",
    text: "Three gaps remain, so the board has room to reorder."
  },
  {
    label: "Next Strategy",
    value: "Group A items",
    text: "Use the left shelf as a staging lane for the next match."
  }
];

export function GoodsSortSolverPreview() {
  return (
