const tips = [
  ...
  "Plan pour order ahead",
  "Watch temporary storage",
  "Restart early if bottles lock"
];

export function WaterSortTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven bottle-safe moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Hard Water Sort boards are
          easier when empty bottle timing and anchor colors are planned together.
        </p>
      </div>
