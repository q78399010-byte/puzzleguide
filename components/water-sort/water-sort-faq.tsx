import { waterSortFaq } from "@/data/games";

type WaterSortFaqItem = {
  question: string;
  answer: string;
};

type WaterSortFaqProps = {
  faq?: WaterSortFaqItem[];
};

export function WaterSortFaq({ faq = waterSortFaq }: WaterSortFaqProps) {
  return (
