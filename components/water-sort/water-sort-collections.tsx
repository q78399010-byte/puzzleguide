...
const collections = [
  {
    ...
    text: "Start with empty bottle basics and clean color stack routes.",
    href: routes.game("water-sort")
  },
  {
    title: "Hard Levels",
    text: "Find stricter storage locks, rare color traps, and exact pour order.",
  ...
  },
  {
    ...
    text: "Use the Water Sort walkthrough hub as a daily solving path.",
    href: routes.walkthrough("water-sort")
  },
  {
    title: "Expert Strategies",
    text: "Study empty bottle timing, anchor colors, and late-board storage traps.",
    href: routes.tip("water-sort")
  },
  {
    title: "Speed Runs",
    text: "Practice shorter pour routes with fewer bottle resets.",
    href: routes.solution("water-sort")
  }
];

export function WaterSortCollections() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Curated bottle paths
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Six static collections for moving from bottle basics to difficult Water
