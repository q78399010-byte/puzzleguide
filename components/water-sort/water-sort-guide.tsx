...
const guideCards = [
  {
    title: "Guide",
    text: "Understand bottle pressure, anchor colors, and when to delay mixed pours.",
    href: routes.game("water-sort")
  },
  {
    title: "Walkthrough",
    text: "Jump into written level paths for empty bottle timing, color stacks, and cleanup order.",
    href: routes.walkthrough("water-sort")
  },
  {
    title: "Solutions",
    text: "Use concise solution notes when a board locks near the final color groups.",
    href: routes.solution("water-sort")
  }
];

export function WaterSortGuide() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold tracking-tight text-ink sm:text-6xl">
            Water Sort Guides & Solutions
          </h2>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-muted sm:text-xl">
            Walkthroughs, tips, bottle strategies and puzzle solutions.
          </p>
        </div>
        <div className="rounded-3xl border border-white/60 bg-white/80 p-5 shadow-2xl shadow-blue-500/10 backdrop-blur-xl">
          ...
          <p className="mt-3 text-2xl font-bold tracking-tight text-ink">
            Keep one empty bottle open before chasing easy pours.
          </p>
          <p className="mt-3 text-sm leading-6 text-muted">
            Water Sort levels usually fail when every spare bottle is filled too
            early. Preserve one empty space until the next color stack can clear.
          </p>
        </div>
      </div>
