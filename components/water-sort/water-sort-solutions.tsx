...
const walkthroughBlocks = [
  {
    title: "Empty Bottle",
    text: "Keep a working bottle open before moving layers that cannot finish immediately."
  },
  {
    title: "Anchor Color",
    text: "Build the cleanest color stack first so later pours have a safe destination."
  },
  {
    title: "Cleanup",
    text: "Finish matched bottles only after every remaining color has a clear transfer route."
  }
];

export function WaterSortSolutions() {
  return (
    <section className="mt-8 grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
      <article className="rounded-3xl border border-white/55 bg-white/75 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-xl sm:p-10">
        ...
        <p className="mt-4 text-sm leading-6 text-muted">
          Water Sort solutions work best when every pour opens storage, extends a
          clean color stack, or prepares the final bottle cleanup route.
        </p>
        <Link
