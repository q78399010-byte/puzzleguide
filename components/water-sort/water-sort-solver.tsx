const solverSteps = [
  { label: "Step 1", title: "Keep one bottle empty" },
  { label: "Step 2", title: "Build anchor color" },
  { label: "Step 3", title: "Move rare colors carefully" },
  { label: "Step 4", title: "Finish clean stacks" }
];

const solverStats = [
  { label: "Difficulty", value: "Easy" },
  { label: "Moves", value: "16" },
  { label: "Estimated Time", value: "3 min" },
  { label: "Success Rate", value: "72%" }
];

export function WaterSortSolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple four-step solving pattern for Water Sort boards. This is
