type SolverSignalsCardProps = {
  signals: string[];
};

export function SolverSignalsCard({ signals }: SolverSignalsCardProps) {
  return (
      ...
      <div className="mt-6 grid gap-3">
        {signals.map((signal) => (
          ...
          >
            ...
            <span className="text-sm font-bold text-ink">{signal}</span>
          </article>
        ))}
      </div>
    </section>
