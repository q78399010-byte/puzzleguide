import { colorWoodJamFaq } from "@/data/games";

type ColorWoodJamFaqItem = {
  question: string;
  answer: string;
};

type ColorWoodJamFaqProps = {
  faq?: ColorWoodJamFaqItem[];
};

export function ColorWoodJamFaq({ faq = colorWoodJamFaq }: ColorWoodJamFaqProps) {
  return (
