...
const guideCards = [
  {
    title: "Guide",
    text: "Understand lane pressure, matching exits, and when to delay easy-looking pieces.",
    href: routes.game("color-wood-jam")
  },
  {
    title: "Walkthrough",
    text: "Jump into written level paths for opening moves, blockers, and final cleanup.",
    href: routes.walkthrough("color-wood-jam")
  },
  {
    title: "Solutions",
    text: "Use concise solution notes when a board locks up near the last few moves.",
    href: routes.solution("color-wood-jam")
  }
];

export function ColorWoodJamGuide() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
        <div>
          ...
          <h2 className="mt-5 max-w-3xl text-4xl font-bold tracking-tight text-ink sm:text-6xl">
            Color Wood Jam Guides & Solutions
          </h2>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-muted sm:text-xl">
            Walkthroughs, tips, solutions and puzzle strategies.
          </p>
        </div>
        <div className="rounded-3xl border border-white/60 bg-white/80 p-5 shadow-2xl shadow-blue-500/10 backdrop-blur-xl">
          ...
          <p className="mt-3 text-2xl font-bold tracking-tight text-ink">
            Clear space before chasing color matches.
          </p>
          <p className="mt-3 text-sm leading-6 text-muted">
            Color Wood Jam levels usually fail when the center lane closes early.
            Keep one reserve path open until the main blocker can exit.
          </p>
        </div>
      </div>
