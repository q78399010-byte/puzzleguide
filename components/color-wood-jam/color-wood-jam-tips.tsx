const tips = [
  "Clear the center lane first",
  "Move blockers before small pieces",
  "Watch future exits",
  "Avoid dead ends",
  "Keep space available",
  "Think two moves ahead",
  "Restart early if trapped"
];

export function ColorWoodJamTips() {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-ink">
            Seven reliable moves
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-muted">
          Use these before checking a full solution. Most difficult boards become
          readable once the lane and blocker order are clear.
        </p>
      </div>
