...
const collections = [
  {
    ...
    text: "Start with easier boards and practice lane discipline.",
    href: routes.game("color-wood-jam")
  },
  {
    title: "Hard Levels",
    text: "Find pages for stricter blockers, late traps, and exact move order.",
  ...
  },
  {
    ...
    text: "Use the Color Wood Jam walkthrough hub as a daily solving path.",
    href: routes.walkthrough("color-wood-jam")
  },
  {
    title: "Expert Strategies",
    text: "Study blocker timing, future exits, and late-board space control.",
    href: routes.tip("color-wood-jam")
  },
  {
    title: "Speed Runs",
    text: "Practice shorter routes with fewer resets and cleaner cleanup moves.",
    href: routes.solution("color-wood-jam")
  }
];

export function ColorWoodJamCollections() {
  return (
    <section className="mt-8 rounded-3xl border border-white/55 bg-white/75 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-xl sm:p-10">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <p className="max-w-md text-sm leading-6 text-muted">
          Six static collections for moving from basic practice to difficult
          Color Wood Jam walkthrough demand and faster solution routes.
        </p>
      </div>
