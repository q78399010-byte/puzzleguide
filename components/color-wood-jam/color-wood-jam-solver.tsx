const solverSteps = [
  { label: "Step 1", title: "Clear center lane" },
  { label: "Step 2", title: "Move blockers first" },
  { label: "Step 3", title: "Open exit path" }
];

const solverStats = [
  { label: "Difficulty", value: "Hard" },
  { label: "Moves", value: "18" },
  { label: "Estimated Time", value: "2 min" },
  { label: "Success Rate", value: "67%" }
];

export function ColorWoodJamSolver() {
  return (
      ...
      <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            A simple three-step solving pattern for Color Wood Jam boards. This
            is static guidance and does not connect to player data or live game
            state.
          </p>
        </div>
